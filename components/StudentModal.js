...
const StudentModal = _ref => {
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    value: ""
  }, "Bitte w\xE4hlen"), masterData.schoolYears.map(year => /*#__PURE__*/React.createElement("option", {
    key: year,
    value: year
    ...
    value: ""
  }, "Bitte w\xE4hlen"), Object.keys(masterData.schools || {}).map(school => /*#__PURE__*/React.createElement("option", {
    key: school,
    value: school
    ...
    value: ""
  }, "Bitte w\xE4hlen"), formData.school && ((_masterData$schools$f = masterData.schools[formData.school]) === null || _masterData$schools$f === void 0 ? void 0 : _masterData$schools$f.map(className => /*#__PURE__*/React.createElement("option", {
    key: className,
    value: className
